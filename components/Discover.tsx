				...
				<div className="row h-100 justify-content-center align-items-center">
					<div className="col-lg-6 col-md-12">
						<div className="discover-content">
							...
							<p>
								Gulf Motorcycles offers a full range of repairs & maintenance
								services coupled by a wide array of spare parts ensuring
								complete care for any two wheeler delivery motorcycles across in
								Dubai.
							</p>
							<p>
								Our professionals are trained to manage all brands of
								motorcycles and are experts at Dubai's favorite delivery bikes
								such as Bajaj Pulsar, Honda Unicorn, Yamaha YBR 125, Benelli TNT
								150.
							</p>
							<p>
								...
								expectations. "Affordability and quality service" is our motto.
								It is important to us that customers can rely on Gulf
								Motorcycles with a peace of mind, and most importantly, the
								peace of ride.
							</p>
							<ul>
								<li>
