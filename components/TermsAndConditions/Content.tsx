  ...
  return (
    <section className="ptb-100">
      <div className="container">
        ...
        <p>Welcome to Gulf Motorcycles!</p>

        <p>
          These terms and conditions outline the rules and regulations for the
          use of GULF MOTORCYCLE for Motorcycles Repairing's Website, located at
          gulfmotorcycles.com.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Gulf Motorcycles if you do not
        ...
        <p>
          We employ the use of cookies. By accessing Gulf Motorcycles, you
          agreed to use cookies in agreement with the GULF MOTORCYCLE for
          Motorcycles Repairing's Privacy Policy.{" "}
        </p>
        ...
        <p>
          Unless otherwise stated, GULF MOTORCYCLE for Motorcycles Repairing
          and/or its licensors own the intellectual property rights for all
          material on Gulf Motorcycles. All intellectual property rights are
          reserved. You may access this from Gulf Motorcycles for your own
        ...
        <p>You must not:</p>
        <ul>
          <li>Republish material from Gulf Motorcycles</li>
          <li>Sell, rent or sub-license material from Gulf Motorcycles</li>
          <li>Reproduce, duplicate or copy material from Gulf Motorcycles</li>
          <li>Redistribute content from Gulf Motorcycles</li>
        </ul>
        ...
        <p>
          ...
          GULF MOTORCYCLE for Motorcycles Repairing does not filter, edit,
          publish or review Comments prior to their presence on the website.
          Comments do not reflect the views and opinions of GULF MOTORCYCLE for
          Motorcycles Repairing,its agents and/or affiliates. Comments reflect
          the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, GULF MOTORCYCLE
          for Motorcycles Repairing shall not be liable for the Comments or for
        ...
        <p>
          GULF MOTORCYCLE for Motorcycles Repairing reserves the right to
        ...
        <p>
          You hereby grant GULF MOTORCYCLE for Motorcycles Repairing a
        ...
        <p>
          ...
          the hyperlink compensates the absence of GULF MOTORCYCLE for
          Motorcycles Repairing; and (d) the link is in the context of general
        ...
        <p>
          ...
          sending an e-mail to GULF MOTORCYCLE for Motorcycles Repairing. Please
        ...
        <p>
          No use of GULF MOTORCYCLE for Motorcycles Repairing's logo or other
